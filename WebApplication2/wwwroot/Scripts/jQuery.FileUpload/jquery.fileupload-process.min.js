...
b)};g.index=e;a._processing+=1;a._processingQueue=a._processingQueue.pipe(f,f).always(function(){--a._processing;0===a._processing&&a._trigger("processstop")})}));return this._processingQueue},_create:function(){this._super();this._processing=0;this._processingQueue=d.Deferred().resolveWith(this).promise()}})});
